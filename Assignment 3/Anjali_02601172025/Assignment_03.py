#Name: Anjali
#Enrollment num: 02601172025
#Branch: CSE-AI-1

# ASSIGNMENT-03

# 01 Function to print the first ten natural numbers
...
# 02 Function to calculate sum of first N natural numbers
...
# 03 Function to reverse a number
def to_reverse(n):
    return int(str(n)[::-1])
...
# 04 Function to count digits in a number
def count_digits(n):
    return len(str(n))
...
#05 Function to check palindrome number
def is_palindrome(n):
    if str(n)==str(n)[::-1]:
...
# 06 Function to generate Fibonacci series
...
# 08 Create a text file and store student details 
