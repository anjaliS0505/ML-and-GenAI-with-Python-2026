...
# ASSIGNMENT-02
# 01 Find sum of first ten natural numbers
s=sum(range(1,11))
print(f"Sum of first ten natural numbers is: {s}")



# 02 Find factorial of a number
...
# 04 Find largest among three numbers
